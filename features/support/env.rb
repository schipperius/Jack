...
# It is recommended to regenerate this file in the future 
# when you upgrade to a newer version of cucumber-rails. 
...
# In order to ease the transition to Capybara we set the default here.
# If you would prefer to use XPath just remove this line and adjust any
