...
module Jack
  class Application < Rails::Application
    # Settings in config/environments/* takes precedence over those specified
    # here. 
    # Application configuration should go into files in
    # config/initializers, .rb files in that directory are 
    ...
    # This will create an empty whitelist of attributes available
    # for mass-assignment for all models in your app. 
    # As such, your models will need to explicitly 
    # whitelist or blacklist accessible parameters by using
    ...
    # by the schema dumper, like if you have constraints or 
